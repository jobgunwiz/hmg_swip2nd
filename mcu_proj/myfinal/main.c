...
//d mode interrupt switch
extern int red_t_switch;
extern int blue_t_switch;
...
void init_D(){
    ...
    init_ERU2();//interrupt red/blue switch
...
void timer_D(){
    ...
    */
    ...
    else if(blue_t_switch){    //BUT BLUE PRESS
        //d_freq_red = 40000;
